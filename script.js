...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const playRandomChannelSound = () => {
    ...
    channelSounds[randomIndex].play().catch(err => console.error(err));
  };
  ...
  // Dynamic Module Loading (if needed)
  ...
  // Intersection Observer for YouTube audio control on Channel 1

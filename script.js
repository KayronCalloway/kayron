// Global Variables
let videoPlayer;
let soundMuted = false; // Global mute state
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  powerButton.addEventListener("touchstart", () =>
    powerButton.classList.add("touch-glow")
  );
  ...
  powerButton.addEventListener("click", () => {
    ...
    tl.to(landing, { duration: 0.15, backgroundColor: "#fff", ease: "power2.out" })
      ...
      .to(
        "#landingSubtitle .subtitle-item",
        { duration: 1, opacity: 1, ease: "power2.out", stagger: 0.5 },
        "+=0.3"
      );
  });
